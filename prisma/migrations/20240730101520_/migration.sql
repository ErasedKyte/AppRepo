/*
  ...
  - Added the required column `AntennaAzimuth4` to the `SarfForm` table without a default value. This is not possible if the table is not empty.
  - Added the required column `AntennaSize4` to the `SarfForm` table without a default value. This is not possible if the table is not empty.
  - Added the required column `NoOfAntenna4` to the `SarfForm` table without a default value. This is not possible if the table is not empty.
  - Added the required column `RequiredAntennaHeight4` to the `SarfForm` table without a default value. This is not possible if the table is not empty.
...
CREATE TABLE "new_SarfForm" (
    ...
    "NoOfAntenna4" INTEGER NOT NULL,
    "AntennaSize4" TEXT NOT NULL,
    "RequiredAntennaHeight4" INTEGER NOT NULL,
    "AntennaAzimuth4" REAL NOT NULL
);
